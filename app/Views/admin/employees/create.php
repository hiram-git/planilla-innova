                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="tiene_bono_asistencia" name="tiene_bono_asistencia" value="1">
                                                    <label class="custom-control-label" for="tiene_bono_asistencia">
