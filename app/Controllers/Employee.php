    ...
    public function store()
    {
        ...
        try {
            ...
            $employeeData = [
                ...
                'marca_asistencia' => $data['marca_asistencia'] ?? 0,
                'permite_horas_extras' => isset($data['permite_horas_extras']) ? 1 : 0,
                'tiene_bono_asistencia' => isset($data['tiene_bono_asistencia']) ? 1 : 0,
                'gender' => $data['gender'],
    ...
    public function update($id)
    {
        ...
        try {
            ...
            $updateData = [
                ...
                'marca_asistencia' => $data['edit_marca_asistencia'] ?? 0,
                'permite_horas_extras' => isset($data['edit_permite_horas_extras']) ? 1 : 0,
                'tiene_bono_asistencia' => isset($data['edit_tiene_bono_asistencia']) ? 1 : 0,
