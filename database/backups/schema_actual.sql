...
) ENGINE=InnoDB AUTO_INCREMENT=5017 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `planilla_cabecera` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_fecha` (`fecha`),
  KEY `fk_planilla_tipo` (`tipo_planilla_id`),
  KEY `fk_planilla_frecuencia` (`frecuencia_id`),
...
CREATE TABLE `planilla_detalle` (
  ...
  `partida_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_planilla_cabecera_id` (`planilla_cabecera_id`),
  KEY `idx_employee_id` (`employee_id`),
  KEY `idx_concepto_id` (`concepto_id`)
) ENGINE=InnoDB AUTO_INCREMENT=783704 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
